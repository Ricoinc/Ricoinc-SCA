define('login_register_register.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " "
    ...
    + " </label><div class=\"login-register-register-form-controls\" data-validation=\"control\"><input type=\"text\" name=\"lastname\" id=\"register-lastname\" class=\"login-register-register-form-input\"></div></div><div class=\"login-register-register-form-controls-group\" data-validation=\"control-group\"><label class=\"login-register-register-form-label\" for=\"register-companyname\"> "
    + alias3((compilerNameLookup(helpers,"translate") || (depth0 && compilerNameLookup(depth0,"translate")) || alias2).call(alias1,"Company Name <small class=\"login-register-register-form-required\">*</small>",{"name":"translate","hash":{},"data":data}))
    + " </label><div class=\"login-register-register-form-controls\" data-validation=\"control\"><input type=\"text\" name=\"register-companyname\" id=\"register-companyname\" class=\"login-register-register-form-input\"></div></div> "
    ...
    + " </small></p></div></div><div class=\"login-register-register-form-controls-group\" data-validation=\"control-group\"><label class=\"login-register-register-form-label\" for=\"register-companywebsite\"> "
    + alias3((compilerNameLookup(helpers,"translate") || (depth0 && compilerNameLookup(depth0,"translate")) || alias2).call(alias1,"Company website",{"name":"translate","hash":{},"data":data}))
    + " </label><div class=\"login-register-register-form-controls\" data-validation=\"control\"><input type=\"text\" name=\"companywebsite\" id=\"register-companywebsite\" class=\"login-register-register-form-input\"></div></div><div class=\"login-register-register-form-controls-group\" data-validation=\"control-group\"><label class=\"login-register-register-form-label\" for=\"register-phonenumber\"> "
    ...
    + " </label><div class=\"login-register-register-form-controls\" data-validation=\"control\"><input type=\"text\" name=\"phonenumber\" id=\"register-phonenumber\" class=\"login-register-register-form-input\" placeholder=\""
    + alias3((compilerNameLookup(helpers,"translate") || (depth0 && compilerNameLookup(depth0,"translate")) || alias2).call(alias1,"(123) 456-7891",{"name":"translate","hash":{},"data":data}))
    + "\"></div></div> "
    ...
    + " <iframe id=\"sendemailiframe\" src=\"https://ricoincscautilities.com/sca-newuser/\" style=\"display:;\" width=\"900\" height=\"300\"></iframe>  ";
