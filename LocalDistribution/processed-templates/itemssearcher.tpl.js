define('itemssearcher.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <style media=\"screen\"> .nexsearcher{\n		position: relative; vertical-align: top; background-color: transparent;color:#343741; border-color:#5f6369;outline: none;\n	} </style><script type=\"text/javascript\"> $(document).ready(function(){\n$('span.tt-dropdown-menu').css('margin-top', '0px');\n}); </script><input data-type=\"search-input\" style=\" height:10px; border-bottom-left-radius: 3px; border-top-left-radius: 3px; color:#343741; border-color:#5f6369;\" class=\"itemssearcher-input typeahead searcherinputs\"\n	placeholder=\""
