define('facets_item_cell_grid.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <div class=\"facets-item-cell-grid-quick-view-wrapper\"><a href=\""
    ...
    + "\" class=\"facets-item-cell-grid-quick-view-link\" data-toggle=\"show-in-modal\" style=\"background-color:#cd163f; border-color:#cd163f;\"><i class=\"facets-item-cell-grid-quick-view-icon\" ></i> "
  ...
  return " <script type=\"text/javascript\"> $(document).ready(function(){\n	$(\"span.hotmarket\").each(function() {\n		if($(this).text() == 'true'){\n			$(this).show();\n			$(this).empty();\n			$(this).append( '<img src=\"https://system.na3.netsuite.com/c.3500213/SSP%20Applications/NetSuite%20Inc.%20-%20SCA%20Kilimanjaro/Development/img/hotmarket-sca.png\" alt=\"img\" style=\"width:90px;position: absolute; z-index: 2;\">' );\n		}\n\n	});\n\n}); </script><div class=\"facets-item-cell-grid\" data-type=\"item\" data-item-id=\""
    ...
    + "\"><span class=\"hotmarket\" style=\"display:none;\" >"
    ...
    + "\"/><div class=\"facets-item-cell-grid-image-wrapper\" style=\"background-color:;\"><a class=\"facets-item-cell-grid-link-image\" href=\""
    + alias4(((helper = (helper = compilerNameLookup(helpers,"url") || (depth0 != null ? compilerNameLookup(depth0,"url") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
    ...
    + " </div><div class=\"facets-item-cell-grid-details\"><a class=\"facets-item-cell-grid-title\" href=\""
    + alias4(((helper = (helper = compilerNameLookup(helpers,"url") || (depth0 != null ? compilerNameLookup(depth0,"url") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
    + "\"><span itemprop=\"upccode\">"
    ...
    + "</span></a><a class=\"facets-item-cell-grid-title\" href=\""
    + alias4(((helper = (helper = compilerNameLookup(helpers,"url") || (depth0 != null ? compilerNameLookup(depth0,"url") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
    + "\"><span itemprop=\"name\">"
    + alias4(((helper = (helper = compilerNameLookup(helpers,"sku") || (depth0 != null ? compilerNameLookup(depth0,"sku") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"sku","hash":{},"data":data}) : helper)))
    ...
    + "</span><div class=\"facets-item-cell-grid-price\" data-view=\"ItemViews.Price\"></div> "
    ...
    + " <div data-view=\"ItemDetails.Options\"></div><div data-view=\"Cart.QuickAddToCart\"></div><div class=\"facets-item-cell-grid-stock\"><div data-view=\"ItemViews.Stock\" class=\"facets-item-cell-grid-stock-message\"></div></div><div data-view=\"StockDescription\"></div></div></div>  ";
