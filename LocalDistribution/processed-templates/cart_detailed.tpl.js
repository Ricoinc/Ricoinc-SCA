define('cart_detailed.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <h1 class=\"cart-detailed-title\"> "
    ...
    + " <small class=\"cart-detailed-title-details-count\" style=\"color:#5f6369;\"> "
    ...
    return " <h2 style=\"color:#cd163f;\" class=\"cart-detailed-title\">"
  ...
  return " <div class=\"cart-detailed-proceed-to-checkout-container\"><a class=\"cart-detailed-proceed-to-checkout\" data-action=\"sticky\" href=\"#\" data-touchpoint=\"checkout\" data-hashtag=\"#\" style=\"text-align: center; color: white; border: none; background-color:#cd163f;\"> "
    ...
    + " </a><a class=\"cart-detailed-proceed-to-checkout\" data-action=\"sticky\" href=\"/search\" style=\"text-align: center; color: white; border: none; background-color:#5f6369; margin-top:15px;\"> "
  ...
  return " <div class=\"cart-detailed\"><div class=\"cart-detailed-view-header\"><header class=\"cart-detailed-header\"> "
    ...
    + " </div></div><script type=\"text/javascript\"> $(document).ready(function(){\n\n\n\n	$( \".searcherinputs\" ).each(function( index ) {\n  if (index == 3) {\n		 $( this ).removeAttr(\"style\");\n		 $( this ).addClass(\"nexsearcher\");\n		 $( this ).css('border-color', '#5f6369');\n\n	}\n});\nsetTimeout(function(){\n  $('a.sc-pusher-header-back').attr('style', 'color:#5f6369');\n}, 100);\n\n\n\n\n\n	}); </script>  ";
