define('recently_viewed_items.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    return " <aside class=\"recently-viewed-items\"><h3 style=\"color:#cd163f;\">"
    ...
    + "</h3><div data-type=\"backbone.collection.view.rows\"></div></aside> ";
  ...
  return " "
    ...
    + "  ";
},"useData":true}); template.Name = 'recently_viewed_items'; return template;});