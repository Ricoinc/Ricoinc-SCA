define('facets_item_list_sort_selector.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <select data-type=\"navigator\" class=\"facets-item-list-sort-selector\" style=\" border-color:#5f6369;\"> "
    ...
    + " </select>  ";
},"useData":true}); template.Name = 'facets_item_list_sort_selector'; return template;});