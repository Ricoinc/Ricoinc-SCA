define('facets_item_cell_list.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <div class=\"facets-item-cell-list-quick-view-wrapper\"><a href=\""
    + alias3(((helper = (helper = compilerNameLookup(helpers,"url") || (depth0 != null ? compilerNameLookup(depth0,"url") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
    + "\" class=\"facets-item-cell-list-quick-view-link\" data-toggle=\"show-in-modal\" style=\"background-color:#cd163f; border-color:#cd163f;\"><i class=\"facets-item-cell-list-quick-view-icon\"></i> "
  ...
  return " <a class=\"facets-item-cell-list-name\" href='"
    ...
    + " </span></a><br><br><a class=\"facets-item-cell-list-name\" href='"
    + alias4(((helper = (helper = compilerNameLookup(helpers,"url") || (depth0 != null ? compilerNameLookup(depth0,"url") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
    + "'><span itemprop=\"name\"> "
    ...
    + " </span></a><br><br><span itemprop=\"name\" style=\"color:#343741;\"> "
  ...
  return " <script type=\"text/javascript\"> $(document).ready(function(){\n	$(\"a.hotmarket\").each(function() {\n		if($(this).text() == 'true'){\n			$(this).show();\n			$(this).empty();\n			//$(this).append( '<i class=\"fas fa-star \" style=\"color: #FED065;font-size: 18px; position: absolute; z-index: 2; \"></i>' );\n			$(this).append( '<img src=\"https://system.na3.netsuite.com/c.3500213/SSP%20Applications/NetSuite%20Inc.%20-%20SCA%20Kilimanjaro/Development/img/hotmarket-sca.png\" alt=\"img\" style=\"width:90px;position: absolute; z-index: 2;\">' );\n		}\n	});\n}); </script><a class=\"hotmarket\" style=\"display:none;\" >"
    ...
    + "</a><div class=\"facets-item-cell-list\" itemprop=\"itemListElement\"  data-item-id=\""
