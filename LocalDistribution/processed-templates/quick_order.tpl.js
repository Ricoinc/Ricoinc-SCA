define('quick_order.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <div class=\"quick-order\"><div class=\"quick-order-divider\"><div class=\"quick-order-expander-head\" ><a style=\"border-color:#5f6369; color:#343741;\" class=\"quick-order-expander-head-toggle "
    ...
    + "\" id=\"quick-order\" data-target=\"#quick-order\" style=\"border-color:#5f6369;\"><div class=\"quick-order-expander-container\"><div data-view=\"QuickAddView\"></div></div></div></div></div>  ";
