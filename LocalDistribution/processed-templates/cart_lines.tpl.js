define('cart_lines.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <a "
    ...
    + " class=\"cart-lines-name-link\" style=\"color:#5f6369;\"> "
  ...
  return " <tr id=\""
    ...
    + " cart-lines-row\" ><td class=\"cart-lines-table-first\"><div class=\"cart-lines-thumbnail\"> "
    ...
    + " </div></td><td class=\"cart-lines-table-middle\"><div class=\"cart-lines-name\"> "
    ...
    + " </div><div class=\"cart-lines-price\"><div data-view=\"Item.Price\"></div></div><div data-view=\"Item.Sku\"></div><div data-view=\"Item.Tax.Info\"></div><div class=\"cart-lines-options\"><div data-view=\"Item.SelectedOptions\"></div></div> "
    ...
    + " <div data-view=\"StockDescription\"></div><div class=\"cart-lines-item-actions-desktop\" data-view=\"Item.Actions.View\"></div></td><td class=\"cart-lines-table-last\"><div class=\"cart-lines-item-actions-mobile\" data-view=\"Item.Actions.View\"></div><div class=\"cart-lines-shipping-method\" data-view=\"CartLines.PickupInStore\"></div><div class=\"cart-lines-stock\" data-view=\"Product.Stock.Info\"></div> "
