...
<div class="cart-summary">
	<div class="cart-summary-container" style="border-color:#5f6369;">
		<h3 class="cart-summary-title" style="color:#cd163f; background-color: white;border-color:#5f6369;">
	...
	{{#if showPromocodeForm}}
		<div class="cart-summary-grid cart-summary-promocode-container">
			<div class="cart-summary-expander-head">
				<a class="cart-summary-expander-head-toggle collapsed" data-toggle="collapse" data-target="#promo-code-container" aria-expanded="false" aria-controls="promo-code-container" style="border-color:#5f6369; color:#5f6369;">
							{{translate 'Have a Promo Code?'}}
							<i data-toggle="tooltip" class="cart-summary-expander-tooltip" title="{{translate '<b>Promo Code</b><br>To redeem a promo code, simply enter your information and we will apply the offer to your purchase during checkout.'}}" style="color:#343741;"></i>
							<i class="cart-summary-expander-toggle-icon-promocode"></i>
				</a>
			</div>
			<div class="cart-summary-expander-body collapse" role="form" id="promo-code-container" aria-expanded="false" style="border-color:#5f6369; background-color:white;">
	...
	{{#if showActions}}
		<div class="cart-summary-button-container">
			<a id="btn-proceed-checkout" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}}" href="#" data-touchpoint="checkout" data-hashtag="#" style="text-align: center; color: white; border: none; background-color:#cd163f;">
				{{translate 'Proceed to Checkout'}}
			</a>
			<br>
			<a class="cart-summary-button-proceed-checkout" href="/search" style="text-align: center; color: white; border: none; background-color:#5f6369;">
