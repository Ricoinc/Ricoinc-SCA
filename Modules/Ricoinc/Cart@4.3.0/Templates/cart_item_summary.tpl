			...
			{{else}}
				<div class="cart-item-summary-item-list-actionable-container-qty">
					...
					<div class="cart-item-summary-item-list-actionable-input-qty">
							<button type="button" class="cart-item-summary-quantity-remove" data-action="minus" {{#if isMinusButtonDisabled}}disabled{{/if}} style="border: none; background-color:#5f6369;">-</button>
							<input type="number" data-type="cart-item-quantity-input" name="quantity" id="quantity-{{lineId}}" class="cart-item-summary-quantity-value quantity-{{lineId}}" value="{{line.quantity}}" min="1" style="border-color:#5f6369;"/>
							<button type="button" class="cart-item-summary-quantity-add" data-action="plus" style="border: none; background-color:#5f6369;">+</button>
					</div>
