...
<div class="cart-item-actions-links" >
	{{#if isAdvanced}}
		<a href="{{editUrl}}" class="cart-item-actions-item-list-actionable-edit-button-edit btn " style="text-align: center;color: white; border: none; background-color:#5f6369;" data-toggle="show-in-modal">{{translate 'Edit'}}</a>
&nbsp;&nbsp;
		{{#if showSaveForLateButton}}
			<a class="cart-item-actions-item-list-actionable-edit-content-saveforlater btn" style="text-align: center; color: white; border: none; background-color:#343741;" data-action="save-for-later-item" data-internalid="{{lineId}}">
				{{translate 'Save for Later'}}
			</a>
		{{/if}}
	{{/if}}
&nbsp;&nbsp;
	<a class="cart-item-actions-item-list-actionable-edit-content-remove btn" style="text-align: center; color: white; border: none; background-color:#cd163f;" data-action="remove-item" data-internalid="{{lineId}}">
		{{translate 'Remove'}}
	</a>
</div>
