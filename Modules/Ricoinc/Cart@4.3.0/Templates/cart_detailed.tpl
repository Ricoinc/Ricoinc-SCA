...
<div class="cart-detailed">
	<div class="cart-detailed-view-header">
		<header class="cart-detailed-header">
			...
			{{else}}
				<h2 style="color:#cd163f;" class="cart-detailed-title">{{translate 'Your Shopping Cart is empty'}}</h2>
			{{/if}}
		</header>
	</div>
	...
	<div class="cart-detailed-body">
		<section class="{{#if showLines}}cart-detailed-left {{else}}cart-detailed-empty{{/if}}">
			...
			<div class="cart-detailed-proceed-to-checkout-container">
				<a class="cart-detailed-proceed-to-checkout" data-action="sticky" href="#" data-touchpoint="checkout" data-hashtag="#" style="text-align: center; color: white; border: none; background-color:#cd163f;">
					{{translate 'Proceed to Checkout'}}
				</a>

				<a class="cart-detailed-proceed-to-checkout" data-action="sticky" href="/search" style="text-align: center; color: white; border: none; background-color:#5f6369; margin-top:15px;">
