...
{{/unless}}
	...
	<div class="login-register-register-form-controls-group" data-validation="control-group">
		<label class="login-register-register-form-label" for="register-companyname">
			{{translate 'Company Name <small class="login-register-register-form-required">*</small>'}}
		</label>
		<div class="login-register-register-form-controls" data-validation="control">
			<input type="text" name="register-companyname" id="register-companyname" class="login-register-register-form-input">
		</div>
	</div>
	...
	<div class="login-register-register-form-controls-group" data-validation="control-group">
		...
		<div class="login-register-register-form-controls" data-validation="control">
			<input type="text" name="companywebsite" id="register-companywebsite" class="login-register-register-form-input">
		</div>
	</div>
	...
	<div class="login-register-register-form-controls-group" data-validation="control-group">
		...
		<div class="login-register-register-form-controls" data-validation="control">
			<input type="text" name="phonenumber" id="register-phonenumber" class="login-register-register-form-input" placeholder="{{translate '(123) 456-7891'}}">
		</div>
	</div>
