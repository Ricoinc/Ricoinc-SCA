		...
		<div class="product-list-details-later-macro-details">
			<div class="product-list-details-later-macro-info" data-type="item-details">
				...
				<p class="product-list-details-later-macro-name">
					<a href="#" data-touchpoint="home" data-hashtag="#{{itemDetailsUrl}}" class="product-list-details-later-macro-name-link" style="color:#5f6369;">
						{{model.item._name}}
					</a>
				</p>
					...
					<label for="quantity-{{lineId}}">
						...
						{{else}}
							...
							<div class="product-list-details-later-macro-input-qty">
								<button class="product-list-details-later-macro-button-quantity-minus" data-ui-action="minus" style="border: none; background-color:#5f6369;">-</button>
			       				...
			       				<button class="product-list-details-later-macro-button-quantity-add" data-ui-action="add" style="border: none; background-color:#5f6369;">+</button>
			       			</div>
						{{/if}}
					</label>
				</form>
			...
			<div class="product-list-details-later-macro-actions" data-type="item-commands">
				{{#if showActions}}
				<button data-action="add-to-cart" style="text-align: center;color: white; border: none; background-color:#5f6369;" class="product-list-details-later-macro-button-addtocart {{#unless canBeAddedToCart}}disabled{{/unless}}" {{#unless canBeAddedToCart}}disabled{{/unless}}>
					{{translate 'Move to Cart'}}
				</button>
				<button class="product-list-details-later-macro-button-remove" data-action="delete-item" style="text-align: center;color: white; border: none; background-color:#cd163f;">
