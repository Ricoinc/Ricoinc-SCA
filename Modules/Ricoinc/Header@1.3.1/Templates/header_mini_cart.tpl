...
<a class="header-mini-cart-menu-cart-link {{#if showLines}}header-mini-cart-menu-cart-link-enabled{{/if}}" data-type="mini-cart" title="{{translate 'Cart'}}" data-touchpoint="{{cartTouchPoint}}" data-hashtag="#cart" href="#">
	<i class="header-mini-cart-menu-cart-icon" style="color:#cd163f;"></i>
	<span class="header-mini-cart-menu-cart-legend" style="color:#cd163f;">
		{{#if isLoading}}
	 ...
	 {{#if showLines}}
		...
		<div class="header-mini-cart-buttons">
			<div class="header-mini-cart-buttons-left">
				<a href="#" class="header-mini-cart-button-view-cart" data-touchpoint="{{cartTouchPoint}}" data-hashtag="#cart" style="background-color:#cd163f; color:white; border-color:#cd163f; ">
					{{translate 'View Cart'}}
				</a>
			</div>
			<div class="header-mini-cart-buttons-right">
				<a href="#" class="header-mini-cart-button-checkout" data-touchpoint="checkout" data-hashtag="#" style="background-color:#5f6369; color:white; border-color:#5f6369; " >
					{{translate 'Checkout'}}
				</a>
			</div>
		</div>
