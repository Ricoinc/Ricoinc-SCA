...
{{#if showExtendedMenu}}
	<a class="header-profile-welcome-link" href="#" data-toggle="dropdown" style="color:white;">
		...
		{{#if showLogin}}
			<div class="header-profile-menu-login-container">
				<ul class="header-profile-menu-login">
					<li>
						<i class="header-profile-login-icon" style="color:white;"></i>
					</li>
					<li>
						<a class="header-profile-login-link" data-touchpoint="login" data-hashtag="login-register" href="#" style="color:white;">
							{{translate 'Login'}}
						</a>
					</li>
					{{#if showRegister}}
						...
						<li>
							<a class="header-profile-register-link" data-touchpoint="register" data-hashtag="login-register" href="#" style="color:white;">
								{{translate 'Register'}}
							</a>
						</li>
					{{/if}}
