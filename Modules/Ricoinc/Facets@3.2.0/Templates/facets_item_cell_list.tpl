		...
		<div class="facets-item-cell-list-image-wrapper">
			...
			{{#if isEnvironmentBrowser}}
				<div class="facets-item-cell-list-quick-view-wrapper">
					<a href="{{url}}" class="facets-item-cell-list-quick-view-link" data-toggle="show-in-modal" style="background-color:#cd163f; border-color:#cd163f;">
		...
		<h2 class="facets-item-cell-list-title">
			{{#if itemIsNavigable}}
				...
				<a class="facets-item-cell-list-name" href='{{url}}'>
					...
					<span itemprop="name" style="color:#343741;">
						{{team}}
					</span><br><br>
