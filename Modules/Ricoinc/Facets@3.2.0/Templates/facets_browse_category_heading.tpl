...
<link rel="stylesheet" type="text/css" href="http://www.ricoinc.com/SSP%20Applications/NetSuite%20Inc.%20-%20SCA%20Kilimanjaro/Development/Rico_Resources/css/listnav.css">
<style>
...
<script type="text/javascript" src="http://www.ricoinc.com/SSP%20Applications/NetSuite%20Inc.%20-%20SCA%20Kilimanjaro/Development/Rico_Resources/js/vendor.js"></script>
...
<section class="facets-browse-category-heading-list-header">
	...
	{{#if hasBanner}}
		<div class="facets-browse-category-heading-main-image">
			<img src="{{resizeImage banner 'categorybanner'}}" alt="{{pageheading}}" class="originalImg" style="width: 35%;height: auto;"/>
		</div>
	{{/if}}
