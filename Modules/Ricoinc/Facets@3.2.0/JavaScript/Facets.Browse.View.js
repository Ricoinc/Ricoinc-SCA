...
,	[	'SC.Configuration'
	...
	,	'Tracker'
	,	'Facets.Download.Images.View'
	,	'Facets.Download.HotMarket.View'
	,	'Facets.AboutUs.View'
	,	'Facets.ContactUs.View'
	,	'Facets.Catalogs.View'
	,	'Facets.PrivacyPolicy.View'
	,	'Facets.TermsOfUse.View'
	,	'Facets.NewProductSubmission.View'
	,	'Facets.NewCustomer.View'
...
,	function (
	...
	,	Tracker
	, FacetsDownloadImagesView
	, FacetsDownloadHotMarketView
	, FacetsAboutUsView
	,	FacetsContactUsView
	,	FacetsCatalogsView
	,	FacetsPrivacyPolicyView
	,	FacetsTermsOfUseView
	,	FacetsNewProductSubmissionView
	,	FacetsNewCustomerView
	...
	)
{
	...
	,	childViews: {
		...
		,	'Facets.CategorySidebar': function()
			...
			,	'Facets.DownloadImages': function()
				{
					return new FacetsDownloadImagesView({
						model: this.model
					});
				}
			,	'Facets.DownloadHotMarket': function()
				{
					return new FacetsDownloadHotMarketView({
						model: this.model
					});
				}
				,	'Facets.AboutUs': function()
					{
						return new FacetsAboutUsView({
							model: this.model
						});
					}
					,	'Facets.ContactUs': function()
						{
							return new FacetsContactUsView({
								model: this.model
							});
						}
						,	'Facets.Catalogs': function()
							{
								return new FacetsCatalogsView({
									model: this.model
								});
							}
							,	'Facets.PrivacyPolicy': function()
								{
									return new FacetsPrivacyPolicyView({
										model: this.model
									});
								}
								,	'Facets.TermsOfUse': function()
									{
										return new FacetsTermsOfUseView({
											model: this.model
										});
									}
									,	'Facets.NewProductSubmission': function()
										{
											return new FacetsNewProductSubmissionView({
												model: this.model
											});
										}
										,	'Facets.NewCustomer': function()
											{
												return new FacetsNewCustomerView({
													model: this.model
